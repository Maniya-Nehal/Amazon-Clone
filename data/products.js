...
class Clothing extends Products{
  sizeChartLink;
  constructor(productsDetails){
    super(productsDetails);//calls the constructor of parent class
    this.sizeChartLink = productsDetails.sizeChartLink;
    //b default it would use the parents constructors
  }
  extrainfo(){
    return `
    <a href="image/clothing-size-chart.png" target="_blank">Size Chart</a>
